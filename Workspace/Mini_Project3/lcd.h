...
#error "Data bits mode should either be 4 or 8"
...
#define LCD_DATA_DB4_PIN_ID			   PIN3_ID
#define LCD_DATA_DB5_PIN_ID			   PIN4_ID
#define LCD_DATA_DB6_PIN_ID			   PIN5_ID
#define LCD_DATA_DB7_PIN_ID			   PIN6_ID
